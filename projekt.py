...
def door(player):
    ...
    if door_type == "Treasure":
        ...
        if len(player.inv) < 5:
            ...
            while True:
                ...
                if exchange == "Y": 
                    ...
                    print("You've left the treasure and countinued your journey.\n")
                    break
                else:
        ...
        if monster_strength > player.strength:
            ...
            print("You've won the battle against the monster.")
        ...
        if player.hp <= 0: 
            ...
            while True:
                ...
                if play_again == "Y":
                    ...
                    print ("We've had fun with you, see you next time!")
                    print()
                    exit()
                else:
                    print("You need to type Y or N (Y for Yes, N for No): ")  
